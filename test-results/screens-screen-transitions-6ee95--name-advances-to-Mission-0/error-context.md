...
- Name: screens.spec.js >> screen transitions >> 02 Team Registration Screen — validation blocks empty name and valid name advances to Mission 0
- Location: tests/screens.spec.js:23:3
