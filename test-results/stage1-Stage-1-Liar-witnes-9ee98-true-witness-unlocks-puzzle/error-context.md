...
- Name: stage1.spec.js >> Stage 1 >> Liar witness shows warning, true witness unlocks puzzle
- Location: tests/stage1.spec.js:31:3
...
Call log:
  - waiting for locator('.witness-card').filter({ hasText: 'Agente Encubierto' }).locator('.cta-button')
